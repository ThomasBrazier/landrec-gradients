...
packages = c("rstudioapi","tidyr","ggplot2","MareyMap","stringr","gdata","tidyverse","taxizedb","dplyr","rentrez","Biostrings","purrr","ggpubr","reshape2","RColorBrewer","ggplotify","pals","cowplot","lme4","sjPlot","sjmisc","phyr","kableExtra","car","ape","plyr","lmerTest", "viridis", "pbmcapply", "MuMIn", "ggtree", "treeio", "ggnewscale", "dplyr", "data.table", "xlsx", "gridExtra", "hrbrthemes", "parallel", "readr","rcartocolor", "ggh4x", "GenomicRanges", "yaml", "dostats")
...
source(paste0("Source/read.gff.R"))
...
list_species_abbreviations = c("Athal", "Gmax", "Ptrem", "Hsap",
                               "Csin", "Clan", "Msie", "Osat",
                               "Pvul", "Sbic", "Sole", "Taest")
